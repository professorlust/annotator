...
class FormulaSubmitHandler(BaseHandler):
    def post(self):
...
class FormulaPreviousHandler(BaseHandler):
    def post(self):
        ocr_id = int(self.get_argument('ocr_id'))
...
class FormulaNextHandler(BaseHandler):
    def post(self):
        ocr_id = int(self.get_argument('ocr_id'))
        self.get_ocr(ocr_id + 1)
        self.get_mark()
...
class FormulaJumpHandler(BaseHandler):
    def post(self):
